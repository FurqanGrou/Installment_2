                ...
                <!-- progressbar -->
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            @if(app()->getLocale() == 'ar')
                                <p class="text-right">
                                    أعزاءنا أولياء الأمور.. نفيدكم بأنه حان موعد استحقاق الدفعة الثانية من الرسوم الدراسية للفصل الدراسي الثاني 2022
                                ...
                                <div class="w-100">
                                    <table class="table table-bordered text-center" id="table-installment">
                                        ...
                                        <tr>
                                            <td style="font-weight: bold; color: black" class="green">الدفعة الثانية</td>
                                            <td class="green">30%</td>
                                            <td class="green">95$</td>
                                            <td class="green">01-02-2022</td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: bold; color: black">الدفعة الثالثة</td>
                                            <td>30%</td>
                                            <td>95$</td>
                                            <td>01-03-2022</td>
                                        </tr>
                            ...
                            @else
                                ...
                                <p>
                                    Dear Guardian, kindly be informed that the 2nd installment of the Second semester 2022 which costs 95$ is due now.
                                ...
                                <div class="w-100">
                                    <table class="table table-bordered text-center" id="table-installment">
                                        ...
                                        <tr>
                                            <td style="font-weight: bold; color: black" class="green">Second Payment</td>
                                            <td class="green">30%</td>
                                            <td class="green">95$</td>
                                            <td class="green">01-02-2022</td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: bold; color: black">Third Payment</td>
                                            <td >30%</td>
                                            <td>95$</td>
                                            <td>01-03-2022</td>
                                        </tr>
